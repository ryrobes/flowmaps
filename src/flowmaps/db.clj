...
(def results-atom (datom {} "results-atom")) ;; basically a log
(def resolved-paths (datom {} "resolved-paths"))
(def channel-history (datom {} "channel-history"))
;(def channel-history2 (atom {})) ;; waiting time
(def fn-history (datom {} "fn-history"))
(def block-dump (datom {} "block-dump"))
;(def web-push-history (datom [] "web-push-history"))
(def chains-completed (datom [] "chains-completed"))
;(def port-accumulator (datom {} "port-accumulator"))
(def block-defs (datom {} "block-defs"))
(def hidden-values (datom {} "hidden-values"))
(def waffle-data (datom {} "waffle-data"))
